...
const Footer = () => {
  return (
    <>
      <footer className="py-10 bg-[#ecf0f1] border border-[#bdc3c7] ">
        <div className="max-w-container w-full mx-auto grid grid-cols-12 gap-y-4 md:gap-y-0">
          <div className="col-span-12 md:col-span-4 flex flex-col px-3 items-center gap-y-2">
            {/* logo */}
          ...
          <div className='col-span-12 md:col-span-4 flex flex-col gap-y-4 px-3'>
      ...
      <div className="text-sm md:text-base font-bold text-center py-[30px]">
